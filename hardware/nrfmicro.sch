...
U 1 1 5A2ACF99
P 9800 3625
F 0 "J2" H 9800 3725 50  0000 C CNN
F 1 "01x02" H 9800 3425 50  0000 C CNN
F 2 "nrfmicro:connector_swd" H 9800 3625 50  0001 C CNN
...
U 1 1 5D91BF1B
P 1375 1775
F 0 "X2" V 1329 1906 50  0000 L CNN
F 1 "32.768kHz" V 1420 1906 50  0000 L CNN
...
U 1 1 5D91BF21
P 1125 1625
F 0 "C17" V 873 1625 50  0000 C CNN
...
U 1 1 5D91BF27
P 1125 1925
F 0 "C18" V 1285 1925 50  0000 C CNN
...
F 3 "~" H 7850 2475 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 9600 3625 0    50   Input ~ 0
SWDCLK
...
U 1 1 5E070D30
P 2775 4125
F 0 "C20" H 2661 4171 50  0000 R CNN
...
U 1 1 5D91BFCB
P 1475 4100
F 0 "C19" H 1590 4146 50  0000 L CNN
...
U 1 1 5EACC222
P 3000 4875
F 0 "C21" H 3115 4921 50  0000 L CNN
F 1 "4.7uF" H 3115 4830 50  0000 L CNN
F 2 "Capacitor_SMD:C_0201_0603Metric" H 3038 4725 50  0001 C CNN
...
U 1 1 5EACC228
P 3000 5025
F 0 "#PWR0106" H 3000 4775 50  0001 C CNN
F 1 "GND" H 3005 4852 50  0000 C CNN
...
Wire Wire Line
	3275 4475 3275 4725
Text GLabel 3000 4650 1    60   Input ~ 0
VBUS
Wire Wire Line
	3275 4725 3000 4725
Wire Wire Line
...
U 1 1 5EC4EE92
P 4375 850
F 0 "C16" H 4490 896 50  0000 L CNN
F 1 "47nF" H 4490 805 50  0000 L CNN
F 2 "Capacitor_SMD:C_0201_0603Metric" H 4413 700 50  0001 C CNN
...
PD3
Text GLabel 2775 3475 0    60   Input ~ 0
PD2
Text GLabel 4075 4475 3    60   Input ~ 0
PD1
Text GLabel 3875 4475 3    60   Input ~ 0
PD0
Text GLabel 4275 4475 3    60   Input ~ 0
PD4
Text GLabel 4375 4475 3    60   Input ~ 0
PC6
Text GLabel 4575 4475 3    60   Input ~ 0
PD7
Text GLabel 4675 4475 3    60   Input ~ 0
PE6
Text GLabel 4975 4475 3    60   Input ~ 0
PB4
Text GLabel 5475 3475 2    60   Input ~ 0
PB5
Text GLabel 2775 2875 0    60   Input ~ 0
PF4
Text GLabel 2325 2375 1    60   Input ~ 0
PF5
Text GLabel 3875 1775 1    60   Input ~ 0
PF6
Text GLabel 4275 1775 1    60   Input ~ 0
PF7
Text GLabel 4475 1775 1    60   Input ~ 0
PB1
Text GLabel 4375 1775 1    60   Input ~ 0
PB3
Text GLabel 5475 2775 2    60   Input ~ 0
PB2
Text GLabel 2775 3375 0    60   Input ~ 0
PB6
...
U 1 1 5E4580E8
P 10450 3600
F 0 "J6" H 10530 3592 50  0000 L CNN
F 1 "Battery Header" H 10530 3501 50  0000 L CNN
F 2 "nrfmicro:connector_bat" H 10450 3600 50  0001 C CNN
...
F 1 "Battery Conn" H 10530 3151 50  0000 L CNN
F 2 "nrfmicro:JST_PH2_SMT_TH" H 10450 3250 50  0001 C CNN
F 3 "~" H 10450 3250 50  0001 C CNN
	1    10450 3250
	1    0    0    -1  
$EndComp
Text Notes 1350 5925 0    60   ~ 0
Power and Filtering
Text Notes 3200 6175 0    60   ~ 0
LiPo Charging\n
$Comp
L Device:C C24
U 1 1 5E45FD12
P 4550 6775
F 0 "C24" H 4665 6821 50  0000 L CNN
F 1 "10uF" H 4665 6730 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 4588 6625 50  0001 C CNN
...
U 1 1 5E45FD18
P 4100 6775
F 0 "R5" V 4307 6775 50  0000 C CNN
F 1 "4.7K" V 4216 6775 50  0000 C CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 4030 6775 50  0001 C CNN
...
U 1 1 5E45FD1E
P 3500 6875
F 0 "U2" H 3500 7261 50  0000 C CNN
F 1 "MCP73831-2-OT" H 3500 7352 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 3550 6625 50  0001 L CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/20001984g.pdf" H 3350 6825 50  0001 C CNN
	1    3500 6875
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5E45FD24
P 4550 7125
F 0 "#PWR0122" H 4550 6875 50  0001 C CNN
F 1 "GND" H 4555 6952 50  0000 C CNN
...
U 1 1 5E45FD2A
P 4350 7125
F 0 "#PWR0123" H 4350 6875 50  0001 C CNN
F 1 "GND" H 4355 6952 50  0000 C CNN
...
Wire Wire Line
	4350 6775 4350 7125
Text GLabel 3275 7175 0    60   Input ~ 0
VBUS
Text GLabel 4700 6275 2    60   Input ~ 0
VBAT
Wire Wire Line
	3000 6975 3100 6975
...
U 1 1 5E45FD89
P 1600 6125
F 0 "R4" V 1715 6125 50  0000 C CNN
F 1 "10K" V 1806 6125 50  0000 C CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 1530 6125 50  0001 C CNN
...
Wire Wire Line
	1900 6125 1900 6375
Text GLabel 2400 6375 2    60   Input ~ 0
VBAT
Text GLabel 850  6575 0    60   Input ~ 0
VBUS
$Comp
L nrfmicro-rescue:GND #PWR0124
U 1 1 5E45FD3D
P 950 7475
F 0 "#PWR0124" H 950 7225 50  0001 C CNN
F 1 "GND" H 950 7325 50  0000 C CNN
...
U 1 1 5E45FD03
P 950 7275
F 0 "R3" H 1020 7321 50  0000 L CNN
F 1 "100K" H 1020 7230 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 880 7275 50  0001 C CNN
...
U 1 1 5E45FCF3
P 1600 7475
F 0 "#PWR0125" H 1600 7225 50  0001 C CNN
F 1 "GND" H 1600 7325 50  0000 C CNN
...
U 1 1 5E45FCE1
P 1600 7275
F 0 "C23" H 1625 7375 50  0000 L CNN
F 1 "10uF" H 1625 7175 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 1638 7125 50  0001 C CNN
...
U 1 1 5E45FCDB
P 1800 6575
F 0 "Q1" H 2000 6650 50  0000 L CNN
F 1 "DMP2088LCP3-7" H 2000 6575 50  0000 L CNN
F 2 "nrfmicro:X2-DSN1006-3" H 2000 6500 50  0001 L CIN
F 3 "" H 1800 6575 50  0001 L CNN
	1    1800 6575
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5E45FCD5
P 1300 6925
F 0 "D1" H 1300 6709 50  0000 C CNN
F 1 "1N5819" H 1300 6800 50  0000 C CNN
F 2 "Diode_SMD:D_SOD-523" H 1300 6750 50  0001 C CNN
...
U 1 1 5E466542
P 6050 6950
F 0 "Q2" H 6256 6996 50  0000 L CNN
F 1 "DMN3110LCP3-7" H 6256 6905 50  0000 L CNN
F 2 "nrfmicro:X2-DSN1006-3" H 6250 6875 50  0001 L CIN
F 3 "http://www.diodes.com/assets/Datasheets/ds11302.pdf" H 6050 6950 50  0001 L CNN
	1    6050 6950
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 2 "Resistor_SMD:R_0201_0603Metric" V 5680 6700 50  0001 C CNN
...
Power Control\nNormally On\nLow - Off\n
Text GLabel 5850 6450 2    60   Input ~ 0
VDD_nRF
Wire Wire Line
	5750 6450 5850 6450
$Comp
...
Wire Wire Line
	3500 7175 3275 7175
Text GLabel 6275 6600 2    60   Input ~ 0
EXT_GND
$EndSCHEMATC
