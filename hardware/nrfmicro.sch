...
U 1 1 5A2ACF99
P 9300 3675
F 0 "J2" H 9300 3775 50  0000 C CNN
...
U 1 1 5E4580E8
P 10200 3775
F 0 "J6" H 10280 3767 50  0000 L CNN
...
U 1 1 5E470FAD
P 10200 3300
F 0 "J5" H 10280 3292 50  0000 L CNN
F 1 "Battery JST Connector" H 10280 3201 50  0000 L CNN
F 2 "nrfmicro:JST_PH2_SMT_TH" H 10200 3300 50  0001 C CNN
F 3 "~" H 10200 3300 50  0001 C CNN
	1    10200 3300
	1    0    0    -1  
$EndComp
Text Notes 1575 5775 0    60   ~ 0
Power and Filtering
...
U 1 1 5E45FD12
P 5650 6625
F 0 "C24" H 5765 6671 50  0000 L CNN
F 1 "10uF" H 5765 6580 50  0000 L CNN
F 2 "Capacitor_SMD:C_0402_1005Metric" H 5688 6475 50  0001 C CNN
...
U 1 1 5E45FD18
P 5200 6625
F 0 "R5" V 5407 6625 50  0000 C CNN
F 1 "4.7K" V 5316 6625 50  0000 C CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 5130 6625 50  0001 C CNN
...
U 1 1 5E45FD1E
P 4600 6725
F 0 "U2" H 4600 7111 50  0000 C CNN
F 1 "MCP73831-2-OT" H 4600 7202 50  0000 C CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 4650 6475 50  0001 L CIN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/20001984g.pdf" H 4450 6675 50  0001 C CNN
	1    4600 6725
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5E45FD24
P 5650 6975
F 0 "#PWR0122" H 5650 6725 50  0001 C CNN
F 1 "GND" H 5655 6802 50  0000 C CNN
F 2 "" H 5650 6975 50  0001 C CNN
...
U 1 1 5E45FD2A
P 5450 6975
F 0 "#PWR0123" H 5450 6725 50  0001 C CNN
F 1 "GND" H 5455 6802 50  0000 C CNN
...
Wire Wire Line
	5450 6625 5450 6975
Text GLabel 4025 7025 0    60   Input ~ 0
VBUS
Text GLabel 6000 6125 2    60   Input ~ 0
VBAT
Wire Wire Line
	4100 6825 4200 6825
Text GLabel 1550 5975 0    60   Input ~ 0
P0.04
$Comp
L nrfmicro-rescue:R R4
U 1 1 5E45FD89
P 1850 5975
F 0 "R4" V 1965 5975 50  0000 C CNN
F 1 "10K" V 2056 5975 50  0000 C CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 1780 5975 50  0001 C CNN
...
Wire Wire Line
	2150 6775 2700 6775
Text GLabel 2700 6775 2    60   Input ~ 0
VDD_HV
$Comp
L Transistor_FET:BS870 Q2
U 1 1 5E466542
P 8150 4950
F 0 "Q2" H 8356 4996 50  0000 L CNN
F 1 "DMN3110LCP3-7" H 8356 4905 50  0000 L CNN
F 2 "nrfmicro:X2-DSN1006-3" H 8350 4875 50  0001 L CIN
F 3 "http://www.diodes.com/assets/Datasheets/ds11302.pdf" H 8150 4950 50  0001 L CNN
	1    8150 4950
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5E466553
P 7850 4700
F 0 "R6" H 7920 4746 50  0000 L CNN
F 1 "10K" H 7920 4655 50  0000 L CNN
F 2 "Resistor_SMD:R_0201_0603Metric" V 7780 4700 50  0001 C CNN
...
U 1 1 5E4BDC34
P 8250 5150
F 0 "#PWR0126" H 8250 4900 50  0001 C CNN
...
Wire Wire Line
	4600 7025 4025 7025
Text GLabel 8375 4600 2    60   Input ~ 0
EXT_GND
$Comp
L power:VCC #PWR?
U 1 1 5E478C11
...
U 1 1 5E4B9B1C
P 10000 3875
F 0 "#PWR?" H 10000 3625 50  0001 C CNN
...
F 3 "" H 10400 4375 50  0001 C CNN
	...
	0    -1   -1   0   
$EndComp
Text GLabel 2775 3275 0    60   Input ~ 0
POWER_PIN
Text GLabel 5975 5350 0    60   Input ~ 0
VDD_nRF
$Comp
L power:VCC #PWR?
U 1 1 5E671CD5
P 6275 5350
F 0 "#PWR?" H 6275 5200 50  0001 C CNN
F 1 "VCC" H 6275 5500 50  0000 C CNN
...
U 1 1 5E690570
P 6125 5125
F 0 "#FLG?" H 6125 5200 50  0001 C CNN
F 1 "PWR_FLAG" H 5975 5275 50  0000 C CNN
